    ...
    <section className="w-full flex flex-col justify-center items-center">
      ...
      <div className="w-full grid grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 max-lg:px-40 gap-y-10 gap-x-6 px-60 max-md:px-32 max-sm:px-20">
        <ImpactItem
          ...
          description={translations("volunteers")}
        />
        <ImpactItem
          altImage="countries"
          image="/countries.png"
          description={translations("countries")}
        />
        <ImpactItem
          altImage="artists"
          image="/artists.png"
          description={translations("artists")}
        />
        <ImpactItem
          altImage="festivals"
          image="/festivals.png"
          description={translations("festivals")}
        />
        <ImpactItem
          altImage="groups"
          image="/groups.png"
          description={translations("groups")}
        />
        <ImpactItem
          altImage="age"
          image="/age.png"
          description={translations("age")}
        />
        <ImpactItem
          altImage="experience"
          image="/experience.png"
          description={translations("experience")}
        />
        <ImpactItem
          altImage="unesco"
          image="/unesco.png"
          description={translations("unesco")}
        />
        <ImpactItem
          altImage="children"
          image="/children.png"
